...
- [Basic Prompt Definition](https://docs.nitrostack.ai/sdk/typescript/prompts#basic-prompt-definition)
- [Prompt Decorator Options](https://docs.nitrostack.ai/sdk/typescript/prompts#prompt-decorator-options)
- [Prompt Arguments](https://docs.nitrostack.ai/sdk/typescript/prompts#prompt-arguments)
- [Response Format](https://docs.nitrostack.ai/sdk/typescript/prompts#response-format)
- [Dynamic Prompts](https://docs.nitrostack.ai/sdk/typescript/prompts#dynamic-prompts)
- [Middleware Integration](https://docs.nitrostack.ai/sdk/typescript/prompts#middleware-integration)
- [Dependency Injection](https://docs.nitrostack.ai/sdk/typescript/prompts#dependency-injection)
- [Dynamic Prompt Registration](https://docs.nitrostack.ai/sdk/typescript/prompts#dynamic-prompt-registration)
- [Best Practices](https://docs.nitrostack.ai/sdk/typescript/prompts#best-practices)
...
- [Resources Guide](https://docs.nitrostack.ai/sdk/typescript/resources) \- Exposing data resources
...
- [Dependency Injection](https://docs.nitrostack.ai/sdk/typescript/dependency-injection) \- Service injection patterns
- [Events Guide](https://docs.nitrostack.ai/sdk/typescript/events) \- Event-driven architecture

[Previous\\
\\
📚 Resources](https://docs.nitrostack.ai/sdk/typescript/resources) [Next\\
\\
