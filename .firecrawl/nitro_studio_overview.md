...
![NitroStack Studio Interface](https://docs.nitrostack.ai/nitrostudio.png)

_NitroStudio provides a comprehensive testing environment with AI chat integration, tool execution, and live widget preview._
...
See [Standalone Setup](https://docs.nitrostack.ai/studio/standalone) for detailed instructions.
...
2. Verify project has `nitrostack` dependency
...
See [Standalone Setup](https://docs.nitrostack.ai/studio/standalone) for more troubleshooting.
...
- [UI Widgets Guide](https://docs.nitrostack.ai/sdk/typescript/16-ui-widgets-guide.md)

[Previous\\
\\
💻 CLI Reference](https://docs.nitrostack.ai/cli/overview) [Next\\
\\
🚀 Deployment](https://docs.nitrostack.ai/deployment/checklist)
