...
- [Basic Tool Definition](https://docs.nitrostack.ai/sdk/typescript/tools#basic-tool-definition)
- [Tool Decorator Options](https://docs.nitrostack.ai/sdk/typescript/tools#tool-decorator-options)
- [Tool Annotations](https://docs.nitrostack.ai/sdk/typescript/tools#tool-annotations)
- [Output Schema Validation](https://docs.nitrostack.ai/sdk/typescript/tools#output-schema-validation)
- [Input Validation with Zod](https://docs.nitrostack.ai/sdk/typescript/tools#input-validation-with-zod)
- [Execution Context](https://docs.nitrostack.ai/sdk/typescript/tools#execution-context)
- [Middleware Integration](https://docs.nitrostack.ai/sdk/typescript/tools#middleware-integration)
- [Caching and Rate Limiting](https://docs.nitrostack.ai/sdk/typescript/tools#caching-and-rate-limiting)
- [Dependency Injection](https://docs.nitrostack.ai/sdk/typescript/tools#dependency-injection)
- [Error Handling](https://docs.nitrostack.ai/sdk/typescript/tools#error-handling)
- [UI Widgets](https://docs.nitrostack.ai/sdk/typescript/tools#ui-widgets)
- [Dynamic Tool Registration](https://docs.nitrostack.ai/sdk/typescript/tools#dynamic-tool-registration)
- [Best Practices](https://docs.nitrostack.ai/sdk/typescript/tools#best-practices)
...
See the [UI Widgets Guide](https://docs.nitrostack.ai/sdk/typescript/ui/widgets) for complete widget development documentation.
...
Follow snake\_case convention for tool names:
...
- [Resources Guide](https://docs.nitrostack.ai/sdk/typescript/resources) \- Exposing data as resources
- [Prompts Guide](https://docs.nitrostack.ai/sdk/typescript/prompts) \- Creating AI prompts
- [Middleware Guide](https://docs.nitrostack.ai/sdk/typescript/middleware) \- Request/response pipeline
- [Guards Guide](https://docs.nitrostack.ai/sdk/api-reference/guards.md) \- Access control
- [Interceptors Guide](https://docs.nitrostack.ai/sdk/typescript/interceptors) \- Response transformation
- [Pipes Guide](https://docs.nitrostack.ai/sdk/typescript/pipes) \- Input validation and transformation
- [Caching Guide](https://docs.nitrostack.ai/sdk/typescript/caching) \- Advanced caching strategies
- [Rate Limiting Guide](https://docs.nitrostack.ai/sdk/typescript/rate-limiting) \- Protecting against abuse

[Previous\\
\\
🏗️ Server Concepts](https://docs.nitrostack.ai/sdk/typescript/server) [Next\\
\\
📚 Resources](https://docs.nitrostack.ai/sdk/typescript/resources)
