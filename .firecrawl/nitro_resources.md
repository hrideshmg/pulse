...
- [Basic Resource Definition](https://docs.nitrostack.ai/sdk/typescript/resources#basic-resource-definition)
- [Resource Decorator Options](https://docs.nitrostack.ai/sdk/typescript/resources#resource-decorator-options)
- [Resource Annotations](https://docs.nitrostack.ai/sdk/typescript/resources#resource-annotations)
- [URI Templates](https://docs.nitrostack.ai/sdk/typescript/resources#uri-templates)
- [Resource Templates](https://docs.nitrostack.ai/sdk/typescript/resources#resource-templates)
- [Resource Subscriptions](https://docs.nitrostack.ai/sdk/typescript/resources#resource-subscriptions)
- [Response Format](https://docs.nitrostack.ai/sdk/typescript/resources#response-format)
- [MIME Types](https://docs.nitrostack.ai/sdk/typescript/resources#mime-types)
- [Middleware Integration](https://docs.nitrostack.ai/sdk/typescript/resources#middleware-integration)
- [Dependency Injection](https://docs.nitrostack.ai/sdk/typescript/resources#dependency-injection)
- [Dynamic Resource Registration](https://docs.nitrostack.ai/sdk/typescript/resources#dynamic-resource-registration)
- [Best Practices](https://docs.nitrostack.ai/sdk/typescript/resources#best-practices)
...
- [Tools Guide](https://docs.nitrostack.ai/sdk/typescript/tools) \- Creating callable tools
...
- [Events Guide](https://docs.nitrostack.ai/sdk/typescript/events) \- Event-driven updates
- [UI Widgets Guide](https://docs.nitrostack.ai/sdk/typescript/ui/widgets) \- Visual components

[Previous\\
\\
🛠️ Tools](https://docs.nitrostack.ai/sdk/typescript/tools) [Next\\
\\
💬 Prompts](https://docs.nitrostack.ai/sdk/typescript/prompts)
